  ...
  return (
    <div>
      ...
      <div>
        ...
        <form
          className='grid grid-cols-2 gap-4 place-content-center ml-96'
          onSubmit={(e)=>submit(e)}
        >
        <div>
          <p className='txt'>
        ...
        <div className='flex justify-center ml-96'>
          <button type='submit' className='border-4  text-2xl font-bold rounded-full flex justify-center items-center bg-yellow-400 mt-10 w-36 h-12'>Submit</button>
        </div>
        </form>
        <ReactModal
          isOpen={modalIsOpen}
